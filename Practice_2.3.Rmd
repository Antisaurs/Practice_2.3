...
```{r echo=FALSE, purl=F}
xfun::embed_file('D:/R Projects/Practice_2.2/tw_corals.txt')
```
...
TW_corals<-read.table('D:/R Projects/Practice_2.2/tw_corals.txt', header=T, sep='\t', dec='.') 
TW_corals
```
...
```{r,  eval=T}
income<-read.table("D:/R Projects/Practice_2.2/metoo.txt",header=T, sep="\t", dec=".", na.strings = "n/a")
income
```
...
rairuoho_clear<-rairuoho[1:48,1:11]
rairuoho_clear
